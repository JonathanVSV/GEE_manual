...
\caption{Consulta de propiedades de las imágenes contenidas en una colección de imágenes.}\label{fig:unnamed-chunk-142}
\end{figure}
...
\caption{Ejemplo de una consulta de información de la colección de imágenes en la consola.}\label{fig:unnamed-chunk-145}
\end{figure}
...
\caption{Visualización de la primera imagen de la colección de imágenes.}\label{fig:unnamed-chunk-148}
\end{figure}
...
\caption{Ejemplo de una imagen con nubes.}\label{fig:unnamed-chunk-152}
\end{figure}
...
\caption{Ejemplo de una imagen donde se enmascararon las nubes.}\label{fig:unnamed-chunk-155}
\end{figure}
...
\caption{Consulta de información en la consola para verificar que la colección de imágenes contiene la banda NDVI.}\label{fig:unnamed-chunk-156}
\end{figure}
...
\caption{Ejemplo de una imagen de NDVI.}\label{fig:unnamed-chunk-159}
\end{figure}
...
\caption{Imagen de diferencia de NDVI entre dos años.}\label{fig:unnamed-chunk-165}
\end{figure}
...
\caption{Ubicación de la pestaña de importación de datos a GEE.}\label{fig:unnamed-chunk-167}
\end{figure}
...
\caption{Ejemplo de la ventana para importar un vector o tabla.}\label{fig:unnamed-chunk-168}
\end{figure}
...
\caption{Ejemplo de una importación en proceso.}\label{fig:unnamed-chunk-169}
\end{figure}
...
\caption{Opciones disponibles para importar datos en GEE.}\label{fig:unnamed-chunk-170}
\end{figure}
...
\caption{Ubicación del botón para compartir información importada en GEE.}\label{fig:unnamed-chunk-171}
\end{figure}
...
\caption{Visualización de la clasificación.}\label{fig:unnamed-chunk-187}
\end{figure}
...
\caption{Perfil espectral promedio por clase.}\label{fig:unnamed-chunk-189}
\end{figure}
