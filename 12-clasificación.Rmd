...
```{r fc125, echo = F, out.width="60%", fig.cap="Salida de la consola de los primeros diez puntos de validación, matriz de error (error matrix) y precisión total (overall accuracy). Nótese que el total de puntos de validación es de 4290 puntos, pero se muestran sólo los primeros diez para ejemplificar el tipo de salida."}
