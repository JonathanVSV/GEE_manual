...
Usando al final el método `.setOutputMode` sobre un clasificador se puede cambiar la forma que el clasificador entrega los resultados para ello dentro de los paréntesis del método hay que escribir cualquiera de las siguientes opciones:
