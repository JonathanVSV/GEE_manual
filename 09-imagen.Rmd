...
```{r f95, echo = F, out.width="60%", fig.cap="Salida de la consola tras haber seleccionado algunas bandas o agregar propiedades. Nótese los valores en las entradas de 'bands' y 'properties'."}
...
### Adición de bandas {-}
\index{addBands}
El usuario puede agregar una banda al conjunto de bandas que contiene por defecto una imagen, utilizando el método `.addBands`. Por ejemplo, se podría agregar una banda que contenga algún índice calculado con las bandas originales de la imagen. Por ejemplo:
