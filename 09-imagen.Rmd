...
```{r, echo = F, out.width="80%", fig.cap="Salida de la consola tras haber seleccionado algunas bandas o agregar propiedades. Nótese los valores en las entradas de bands y properties."}
...
```{r, echo = F, out.width="80%", fig.cap="Visualización de la máscara de Landsat 8 indicando pixeles con nubes y sin nubes."}
...
```{r, echo = F, out.width="80%", fig.cap="Imagen Landsat después del enmascaramiento de nubes. Nótese que las áreas enmascaradas ahora son transparentes."}
...
```{r, echo = F, out.width="100%", fig.cap="Visualización de las tres capas generadas: DEM sin corte, DEM con corte, DEM con corte y enmascarada."}
