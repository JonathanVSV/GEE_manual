...
output:
  pdf_document:
    extra_dependencies: ["awesomebox", "tcolorbox", "titling", "lmodern", "inputenc", "babel"]
    toc: yes
    toc_depth: 3
...
% Headers
\setlength{\headheight}{29.85403pt}

% Para cambiar los parámetros por default de las cajas de tips
...
knitr::opts_chunk$set(out.width = "80%", dpi=150)
options(width = 300)
```

```{r colorize, include=FALSE, echo = F}
colorize <- function(x) {
    sprintf("\\textcolor[rgb]{%s}{%s}", "0.08,0.28,0.35", x)
}
```
...
var Multipoligono = ee.Feature(ee.Geometry.MultiPolygon([ee.Geometry.Polygon([-61.955, 10.146,         
      								    -61.713, 10.967,
      								    -60.593, 10.881,
    									   -60.68, 10.081]),
