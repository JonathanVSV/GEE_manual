...
3.	Usar `ee.Filter.gte` para seleccionar mediante la condición mayor o igual a ("greater than or equal").
...
*	Seleccionamos el vector cuyo atributo 'COUNTRY_NAME' es igual ('equals') a 'Peru'.
...
// usando el método .randomColumn le asignamos un valor aleatorio (entre 
...
var bufferAleatorio = function(punto){   
  ...
  // Ejecutamos el método .buffer para el objeto llamado 'vector' y el 
  ...
  // calculando el area (con el método.area) en metros cuadrados del 
  // buffer 
