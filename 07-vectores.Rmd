...
El método `.union` permite fusionar las geometrías de dos vectores en una sola geometría de un vector. Las geometrías que están intersectadas serán disueltas y las que no lo están se convertirán en un multipolígono (`r colorize("Fig.")` \@ref(fig:f73)).
...
```
```{r f73, echo = F, out.width="80%", fig.cap="Visualización de la unión de diferentes geometrías, así como la salida de la consola de la intersección, area y perímetro calculados."}
