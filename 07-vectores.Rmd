...
Es importante recalcar que una `ee.Feature` es un vector individual, de modo que sólo puede contener una sola geometría (polígono, línea, punto, multipunto, multipolígono)
