...
Una vez dentro de la API, es importante crear un Home folder que es donde se guardará toda la información del usuario. En esta sección definiremos nuestro nombre de usuario.
