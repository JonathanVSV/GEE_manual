...
```{r f21, echo = F, out.width="40%", fig.cap="Pantalla de inicio en la página de registro de GEE."}
...
La pantalla de repositorios es el espacio donde se guardan y ordenan las rutinas o scripts (en inglés) del usuario. En ella se pueden crear repositorios y carpetas para organizar los archivos de código, como se muestra a continuación (`r colorize("Fig.")` \@ref(fig:f25)):
...
```{r f210, echo = F, out.width="60%", fig.cap="Folder de inicio dentro de la API."}
