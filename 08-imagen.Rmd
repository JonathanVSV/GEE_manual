...
:::: {.bluebox2 data-latex=""}
::: {.awesomeblock data-latex="{5pt}{\faLightbulb}{darkblue}"}
El sistema de coordenadas de referencia usado en el ejemplo anterior se definió de acuerdo a los códigos EPSG. Estos pueden consultarse en el siguiente enlace: https://epsg.io/
:::
::::
