...
### Ejercicio 0: Consulta y procesamiento de imagen
...
Si se desea filtrar por alguna característica de los metadatos se puede hacer mediante `filter` y después definiendo el filtro del metadaro con `ee.Filter`:
