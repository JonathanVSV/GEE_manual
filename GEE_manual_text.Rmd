...
Los objetos básicos del lado del servidor constan de los mismos objetos del cliente, pero únicamente se meten en el contenedor que le indican al servidor qué tipo de objeto es.
...
### Objetos Raster y vector

Este tipo de objetos representan el tipo de objetos con el que se trabajará prácticamente todo en GEE.
