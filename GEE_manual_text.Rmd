...
9. Se puede utilizar el operador `.` para aplicar una función al objeto que lo precede. Por ejemplo, `imagen.updateMask(mascara);`. En este manual, la mayoría de las funciones aplicadas a algún objeto se escribirán precedidas por el operador `.` para evitar errores de sintáxis.
