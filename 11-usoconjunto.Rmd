...
hacer este proceso: para un ráster completo (`r colorize2(".sample")`), para un
rectángulo (`r colorize2(".sampleRectangle")`) o para varias regiones
(`r colorize2(".sampleRegions")`). Por ejemplo, el método `r colorize2(".sample")` toma como
...
```{r fc111, echo = F, out.width="95%", fig.cap="Ejemplo de la salida de la consola de una colección de vectores obtenida mediante el método sample."}
...
proceso: para una única región (`r colorize2(".reduceRegion")`) o para varias regiones
(`r colorize2(".reduceRegions")`). Por ejemplo, el método `r colorize2(".reduceRegion")` permite
...
```{r fc112, echo = F, out.width="95%", fig.cap="Ejemplo de la salida de la consola del promedio obtenido mediante el método (ref:sub6)."}
knitr::include_graphics("Img/reduccion11.png")
```

::: {.bluebox2 data-latex=""}
::: {.awesomeblock data-latex="{5pt}{\\faLightbulb}{darkblue}"}
En algunas ocasiones, los procesos de `r colorize2(".reduceRegions")` o
`r colorize2(".sampleRegions")` pueden demandar muchos recursos computacionales y
...
detalles sobre el procedimiento de interpolación, revisar Basso _et al_.
(1999). Esta interpolación se realiza con el método `r colorize2(".inverseDistance")`,
...
```{r fc113, echo = F, out.width="95%", fig.cap="Visualización de la capa inicial de (ref:sub1), puntos de muestreo e imagen interpolada."}
...
```{r fc114, echo = F, out.width="95%", fig.cap="Visualización de la capa inicial de temperatura de la superficie marina, puntos de muestreo y capa interpolada."}
