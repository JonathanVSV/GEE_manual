...
```{r fc112, echo = F, out.width="80%", fig.cap="Ejemplo de la salida de la consola del promedio obtenido mediante el método reduceRegion."}
...
y finalmente interpolamos las muestras en buffers de 70 km, usando como argumento el promedio y la desviación estándar (`r colorize("Fig.")` \@ref(fig:fc113)).
...
// Definimos un rectángulo de area de estudio al norte de México.
var norteMex =
