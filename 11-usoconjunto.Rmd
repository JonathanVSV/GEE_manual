...
Este método interpola al píxel de interés un valor según cada uno de los puntos más cercanos, y los pondera según su distancia generando un promedio de esos valores. De modo que los píxeles más cercanos tendrán más influencia en el resultado de la interpolación que los píxeles alejados. Este método es descrito por Basso (et al. 1999).
...
// Se crean dos bandas
// adicionales para la imagen indicando la longitud y latitud de cada 
// píxel
