...
```{r, echo = F, out.width="50%", fig.cap="Acercamiento a las herramienta de geometrías en la pantalla de mapa."}
...
Todas las geometrías dibujadas se importarán como una sola colección, pero si se quiere tener geometrías separadas en diferentes colecciones se debe dar clic en `new layer`. Este menú aparecerá cuando se pase el cursor sobre la pestaña de geometrías dibujadas (Fig. 6.6).
